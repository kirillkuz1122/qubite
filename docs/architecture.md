...
- `back/server.js` — HTTP-сервер, middleware, route handlers, auth, organizer/admin/moderation/public endpoints
- `back/src/db.js` — схема SQLite, инициализация БД, прикладные операции и значительная часть бизнес-логики
...
- пользователи и их статусы/роли;
...
- отправки ответов, результаты, рейтинг и аналитические выборки;
- audit log.
