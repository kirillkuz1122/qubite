    ...
    app.post("/api/admin/proxy-servers", requireOwner, async (req, res, next) => {
        try {
            ...
            const server = await upsertProxyServer({
                ...
                countryCode: cleanText(req.body?.countryCode, 4),
                city: cleanText(req.body?.city, 60),
    ...
    app.patch("/api/admin/proxy-servers/:serverUid", requireOwner, async (req, res, next) => {
        try {
            ...
            const server = await updateProxyServer({
                ...
                countryCode: req.body?.countryCode === undefined ? undefined : cleanText(req.body.countryCode, 4),
                city: req.body?.city === undefined ? undefined : cleanText(req.body.city, 60),
                displayName: req.body?.displayName === undefined ? undefined : cleanText(req.body.displayName, 80),
